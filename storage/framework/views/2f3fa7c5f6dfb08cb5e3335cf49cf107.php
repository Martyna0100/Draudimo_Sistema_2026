...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <?php endif; ?>
            <div class="card">
                <div class="card-header"><?php echo e(__('owners.adding_owner')); ?></div>
...
unset($__errorArgs, $__bag); ?>" name="surname" value="<?php echo e(old('surname')); ?>">
                          <div class="invalid-feedback"><?php $__errorArgs = ['surname'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e(old('phone')); ?>">
                          <div class="invalid-feedback"><?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                      ...
                      <button class="btn btn-success" type="submit"><?php echo e(__('owners.add')); ?></button>
                  </form>
                </div>
            </div>
        </div>
